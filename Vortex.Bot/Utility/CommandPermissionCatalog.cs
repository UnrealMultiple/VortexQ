...
{
    public static IReadOnlyList<CommandPermissionInfo> Discover(Assembly assembly) => Discover([assembly]);

    public static IReadOnlyList<CommandPermissionInfo> Discover(IEnumerable<Assembly> assemblies)
    {
        ...
        foreach (var assembly in assemblies
                     ...
                     .DistinctBy(static assembly => assembly.FullName ?? assembly.GetName().Name, StringComparer.OrdinalIgnoreCase))
        {
        ...
        return entries
            ...
            .Select(static group => new CommandPermissionInfo(
                group.Key,
                [.. group.SelectMany(static entry => entry.Permissions)
