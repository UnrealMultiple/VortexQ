...
public static partial class PluginBaseLoggerExtensions
{
    [LoggerMessage(LogLevel.Information, "[{Name}] Initializing v{Version} by {Author}")]
    public static partial void LogInitializing(this ILogger logger, string name, Version version, string author);

    [LoggerMessage(LogLevel.Information, "[{Name}] Initialized")]
    public static partial void LogInitialized(this ILogger logger, string name);

    [LoggerMessage(LogLevel.Information, "[{Name}] Shutting down")]
    public static partial void LogShuttingDown(this ILogger logger, string name);

    [LoggerMessage(LogLevel.Information, "[{Name}] Shut down")]
    public static partial void LogShutDown(this ILogger logger, string name);

    [LoggerMessage(LogLevel.Information, "[{Name}] Commands auto-registered")]
    public static partial void LogCommandsAutoRegistered(this ILogger logger, string name);

    [LoggerMessage(LogLevel.Information, "[{Name}] Config loaded: {Config}")]
    public static partial void LogConfigLoaded(this ILogger logger, string name, string config);

    [LoggerMessage(LogLevel.Error, "[{Name}] Failed to load config: {Config}")]
    public static partial void LogConfigLoadFailed(this ILogger logger, string name, string config, Exception ex);

    [LoggerMessage(LogLevel.Error, "[{Name}] Error during disposal")]
    public static partial void LogDisposalError(this ILogger logger, string name, Exception ex);
}
...
public static partial class PluginHostLoggerExtensions
{
    ...
    [LoggerMessage(LogLevel.Information, "[{Plugin}] Commands auto-registered")]
    public static partial void LogHostCommandsRegistered(this ILogger logger, string plugin);

    [LoggerMessage(LogLevel.Error, "[{Plugin}] Command registration failed")]
    public static partial void LogHostCommandRegFailed(this ILogger logger, string plugin, Exception ex);

    [LoggerMessage(LogLevel.Information, "[{Plugin}] Config loaded: {Config}")]
    public static partial void LogHostConfigLoaded(this ILogger logger, string plugin, string config);

    [LoggerMessage(LogLevel.Error, "[{Plugin}] Failed to load config: {Config}")]
    public static partial void LogHostConfigLoadFailed(this ILogger logger, string plugin, string config, Exception ex);

    [LoggerMessage(LogLevel.Error, "[{Plugin}] Config loading failed")]
    public static partial void LogHostConfigLoadingFailed(this ILogger logger, string plugin, Exception ex);

    [LoggerMessage(LogLevel.Error, "[{Plugin}] Failed to unload config: {Config}")]
    public static partial void LogHostConfigUnloadFailed(this ILogger logger, string plugin, string config, Exception ex);

    [LoggerMessage(LogLevel.Error, "[{Plugin}] Disposal error")]
    public static partial void LogHostDisposalError(this ILogger logger, string plugin, Exception ex);
}
...
public static partial class PluginManagerLoggerExtensions
{
    ...
    [LoggerMessage(LogLevel.Error, "Error unloading plugin context")]
    public static partial void LogContextUnloadError(this ILogger logger, Exception ex);
